...
session_start();
  ...
  $custemail = $_SESSION["email_login"];
   $prodid = $_POST['proid'];
   $qty = $_POST['qty'];
   
   $query= "INSERT INTO orders (CUSTOMER_EMAIL,PRODUCT_ID,ORDER_STATUS, ORDER_QUANTITY) VALUES ('$custemail', '$prodid', \"IN HOLD\", '$qty')" OR DIE ('query failed');
        ...
        <table width="100%">
            ...
            <tbody>
			  <?php
					...
					<td>
					QUANTITY : 
					<input type=\"text\" name=\"qty\" style='text-align:center;'><br>
